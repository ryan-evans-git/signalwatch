CREATE TABLE IF NOT EXISTS rules (
    ...
    condition     TEXT NOT NULL,               -- JSON {"type":..,"spec":..}
    schedule_ns   INTEGER NOT NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS subscriptions (
    ...
    rule_id             TEXT,
    label_selector      TEXT NOT NULL DEFAULT '{}',  -- JSON
    dwell_ns            INTEGER NOT NULL DEFAULT 0,
    repeat_interval_ns  INTEGER NOT NULL DEFAULT 0,
    notify_on_resolve   INTEGER NOT NULL DEFAULT 1,
    channel_filter      TEXT NOT NULL DEFAULT '[]',  -- JSON
    created_at          INTEGER NOT NULL,
    updated_at          INTEGER NOT NULL
);
...
CREATE TABLE IF NOT EXISTS incident_sub_states (
    ...
    resolution_sent  INTEGER NOT NULL DEFAULT 0,
